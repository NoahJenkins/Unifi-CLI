...
func TestSchemaV1AcceptsContractEnvelopes(t *testing.T) {
	...
	tests := map[string]string{
		...
		"doctor":         `{"schema_version":"1","ok":true,"resource":"doctor","action":"check","data":{"version":"v1.1.0","commit":"abc123","config_path":"/tmp/home.yaml","profile":"home","host":"192.0.2.1","site":"default","tls_mode":"system_roots","credential_source":"saved_api_key","ready":true},"meta":{"site":"default","dry_run":false}}`,
